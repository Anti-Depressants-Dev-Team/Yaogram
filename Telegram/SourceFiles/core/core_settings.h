...
public:
	...
	void setScreenCaptureProtection(bool value) {
		_screenCaptureProtection = value;
	}
	[[nodiscard]] bool screenCaptureProtection() const {
		return _screenCaptureProtection.current();
	}
	[[nodiscard]] rpl::producer<bool> screenCaptureProtectionValue() const {
		return _screenCaptureProtection.value();
	}
	[[nodiscard]] rpl::producer<bool> screenCaptureProtectionChanges() const {
		return _screenCaptureProtection.changes();
	}
...
private:
	...
	rpl::variable<bool> _systemDarkModeEnabled = false; // changed for Amoled default
	rpl::variable<bool> _screenCaptureProtection = true;
